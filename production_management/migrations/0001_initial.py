    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_modification', models.DateField(auto_now=True, db_column='Date_modification', null=True)),
                ('heure_modification', models.TimeField(auto_now=True, db_column='Heure_modification', null=True)),
